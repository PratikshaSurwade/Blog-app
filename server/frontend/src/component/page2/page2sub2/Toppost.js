    ...
    return(
        <> 
            <div className="mainPost">
                <div className="mainpostImg"><img src={this.state[0].photo1} alt="Imageshow"/></div>
                <NavLink className="MainImgLink2" to={`/article/${this.state[0]._id}`}>

                <h5 className="postHeading">{this.state[0].title}</h5>
                </NavLink>
                <span  className="postThumbnail">{this.state[0].categories}</span>
                <span className="date"><code>   </code>/<code>   </code>{this.state[0].date}</span>
                <hr></hr>
            </div>
        </>
    )
